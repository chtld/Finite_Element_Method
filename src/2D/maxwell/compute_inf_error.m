function error=compute_inf_error(exact_solution_fun, solution,P,T,Tb, basis_type, der_x,der_y)
...
for n=1:number_of_elements    
    ...
    for i=1:number_of_evaluation_points
       error(k)=abs(feval(exact_solution_fun,evaluation_points(1,i),evaluation_points(2,i))-FE_function_2D(evaluation_points(1,i),evaluation_points(2,i), uh_local, vertices, basis_type, der_x,der_y)); 
       k = k+1;
    end
