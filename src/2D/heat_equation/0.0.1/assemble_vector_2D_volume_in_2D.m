function b = assemble_vector_2D_volume_in_2D(vector_size, pde, mesh, FE, der_test_x,der_test_y)
...
%   此处显示详细说明
    ...
    for n=1: number_of_elements%循环每个单元
        ...
        for beta = 1:number_of_local_basis%循环测试函数的局部基函数
            int_value=Gauss_int_vector_test(pde.rhs, Gauss_weight,Gauss_point,vertices, FE.basis_type_test,beta,der_test_x,der_test_y);%计算高斯积分
