function b = assemble_vector_1D_volume_in_1D(rightside,P,T,Pb,Tb,vector_size,basis_type_test,Gauss_type)
...
%   此处显示详细说明
    ...
    for n=1: number_of_elements
        ...
        for beta = 1:number_of_local_basis
            int_value=Gauss_int_vector_test(rightside,Gauss_weight,Gauss_point,vertices,basis_type_test,beta,0);
